...
def getCommuneSelected():
    if len(liste.curselection()) > 0:
        ...
        print(os.path.exists(r"C:\FORMATION\20210201\cadastre-etalab"))
        if os.path.exists(r"C:\FORMATION\20210201\cadastre-etalab") == False :
            os.mkdir(r"C:\FORMATION\20210201\cadastre-etalab")
        
        # Destination où recuperer le zip
        dest = r'C:\FORMATION\20210201\cadastre-etalab\cadastre.zip'
        ...
        fzip.extractall(r"C:\FORMATION\20210201\cadastre-etalab")
        fzip.close()
        ...
        # Executer le .BAT
        try:
            os.system(r"C:\FORMATION\20210201\cmd_ogr2ogr.bat")
        except:
